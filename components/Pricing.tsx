            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 max-w-5xl mx-auto items-stretch">
                    ...
                    <div className="bg-white border border-gray-100 rounded-[3rem] p-10 md:p-12 shadow-sm hover:shadow-xl transition-all border-b-8 border-b-blue-600 flex flex-col group">
                        <div className="mb-10">
                            <h3 className="text-2xl font-black text-blue-950 mb-3 uppercase tracking-wider">Digital Health Check & Fix</h3>
                            <p className="text-gray-500 font-bold">Perfect for solving a specific problem while giving your device a tune-up.</p>
                        </div>
                        <div className="mb-10 flex items-baseline gap-2">
                            <span className="text-7xl font-black text-blue-950 tracking-tighter">£65</span>
                            <span className="text-gray-400 font-black uppercase text-sm tracking-widest">/ Flat Rate (First Hour)</span>
                        </div>
                        <p className="text-gray-600 mb-10 leading-relaxed font-medium text-lg">
                            Need extra time? <span className="text-blue-600 font-black italic">Just £35 per additional 30 mins</span> if required.
                        </p>
                        <div className="space-y-5 mb-12 flex-grow">
                            {[
                                "Your Main Issue Fixed (Printer, Wi-Fi, Phone, or TV)",
                                "Startup Optimization to boost device speed",
                                "Critical OS Updates & security patches",
                                "Bloatware & Junk File removal",
                                "Includes a physical summary checklist"
                            ].map((item, i) => (
                    ...
                    <div className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 text-white rounded-[3rem] p-10 md:p-12 shadow-2xl relative overflow-hidden flex flex-col border-b-8 border-b-green-500 transform lg:scale-105">
                        ...
                        <div className="mb-10">
                            <h3 className="text-2xl font-black mb-3 uppercase tracking-wider">The Complete Digital MOT</h3>
                            <p className="text-blue-300 font-bold">The ultimate deep-dive check-up for your entire home tech ecosystem.</p>
                        </div>
                        <div className="mb-10 flex items-baseline gap-2">
                            <span className="text-7xl font-black tracking-tighter">£140</span>
                            <span className="text-blue-400 font-black uppercase text-sm tracking-widest">/ Fixed Price (2 Hours)</span>
                        </div>
                        <p className="text-blue-100 mb-10 leading-relaxed font-medium text-lg">
                            No hidden extras. A complete, worry-free digital overhaul.
                        </p>
                        <div className="space-y-5 mb-12 flex-grow">
                            {[
                                "Full Home Wi-Fi signal & speed audit",
                                "Deep Device Security Review & update",
                                "Password & Anti-Scam Hardening",
                                "Full Sync for all household printers & TVs",
                                "Includes a physical 2-page report"
                            ].map((item, i) => (
                ...
                <div className="max-w-3xl mx-auto mt-12 bg-blue-50 border border-blue-100 rounded-3xl p-8 text-center shadow-sm">
                    <h3 className="text-xl md:text-2xl font-black text-blue-950 mb-3 flex items-center justify-center gap-3">
                        <span className="text-2xl">🛡️</span> Our "No Fix, No Fee" Promise
                    </h3>
