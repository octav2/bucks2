...
| **Patch Panels & Outlets** | 24/48-Port RJ45 Keystone Patch Panels & RJ45 Modules | High-density rack-mounted patch panels with color-coded, clearly labelled faceplates installed at every work desk. |
...
- Cat6 / Cat6a network drop installation to desk modules & AP points
- Dado trunking, floor box, and overhead tray cable containment
- 19-inch data rack assembly, mounting, and cable dressing
- 24/48-port RJ45 patch panel punching, wiring, and clear labelling
- Managed PoE switch integration and VLAN network configuration
- Full channel continuity testing and cable mapping documentation

## Our Process
1. **Commercial Site Survey:** We evaluate your floor plan, desk drop requirements, ceiling containment, and rack location.
2. **Fixed Itemized Scope:** You receive an itemized quote detailing drop counts, patch panel specs, and labor costs.
3. **Out-of-Hours Cable Run:** Our engineers execute the cabling, trunking, and rack mounting on evenings or weekends if required.
4. **Testing & Labelled Handover:** We test every RJ45 port and supply a fully labelled patch map for your IT administrator.

## Frequently Asked Questions

### Can you carry out office cabling work outside normal business hours?
...
Standard Cat6 supports up to 1Gbps speeds over 100m (and 10Gbps up to 37–55m). Cat6a is fully shielded and supports 10Gbps speeds over the full 100m distance. We recommend Cat6a for high-bandwidth commercial environments, video editing suites, or future-proofing.

### Do you supply testing documentation upon completion?
Yes. Every single cable run is tested for wire-map continuity and speed performance. We provide a clearly labelled patch diagram matching wall sockets to patch panel ports.

### Can you fix or re-tidy an existing messy server cabinet?
Absolutely. We offer data rack re-dressing and audit services—tracing existing chaotic cables, replacing oversized patch leads with custom lengths, and clearly labelling all ports.